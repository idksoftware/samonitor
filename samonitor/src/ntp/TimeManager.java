...
/**
* This is an abstract class encapsulating
* the method for setting the system time on the local system.
* Setting the local time can  be accomplished by some external
* process of shell-script, or more likely by using the 'Java Native
* Interface'.
...
*/
   ...
   * @exception java.lang.Exception We allow this method to throw 
...
*/
   ...
   *'LocalTimeManager'. More sophisticated implementations should 
   * check the name of the current operating system and
   *  act accordingly. 
   * @exception java.lang.Exception In the default implementation this 
   * method throws an exception if the class 'LocalTimeManager' is not 
   * present, or fails to load. 
   *
   * @see LocalTimeManager
   */
  public static TimeManager getInstance() throws Exception{
      Class c=Class.forName("ntp.LocalTimeManager");
