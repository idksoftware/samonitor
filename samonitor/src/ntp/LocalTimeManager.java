...
/**
 * This class implements TimeManager.setTime(Date) through a native
 * method under Windows 95 (this will presumably also work
 * under NT, if you have the correct permissions).  
