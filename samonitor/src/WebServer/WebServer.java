...
public class WebServer implements HttpConstants {
   ...
   static void loadProps() throws IOException {
	   ...
	   String path = configPath + File.separator + "www" + File.separator + "config.xml"; 
   ...
   public static void Run(String a) throws Exception {
       int port = 8080;
...
outerloop:
           ...
           if (targ.isDirectory()) {
               File indunix = new File(targ, "index.html");
               if (indunix.exists()) {
                   targ = indunix;
               }
               File indwind = new File(targ, "index.htm");
               if (indwind.exists()) {
                   targ = indwind;
               }
           }
   ...
   void sendLogin(File targ, PrintStream ps) throws IOException {
       InputStream is = null;
       ps.write(EOL);
       if (targ.isDirectory()) {
